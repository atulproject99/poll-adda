...
authRouter.post("/register", validateData(RegisterDto), controller.registerUser);
authRouter.post("/verify-email", validateData(VerifyEmailDto), controller.verfiyEmail);
